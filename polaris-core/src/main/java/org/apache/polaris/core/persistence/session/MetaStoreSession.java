 ...
 */
public interface MetaStoreSession {

  /**
   * Get the current metastore manager.
   *
   * @deprecated Only needed for the hack in IcebergCatalogHandler.commitTransaction
   * @return the metastore manager
   */
  @Deprecated
  PolarisMetaStoreManager getMetaStoreManager();

  /**
   * Swap the current metastore manager with a new one.
   *
   * @deprecated Only needed for the hack in IcebergCatalogHandler.commitTransaction
   * @param newMetaStoreManager the new metastore manager
   * @return the old metastore manager
   */
  @Deprecated
  PolarisMetaStoreManager swapMetaStoreManager(PolarisMetaStoreManager newMetaStoreManager);
   ...
   */
  @Nonnull
  List<PolarisBaseEntity> listFullEntitiesAll(
      @Nullable List<PolarisEntityCore> catalogPath,
      @Nonnull PolarisEntityType entityType,
      @Nonnull PolarisEntitySubType entitySubType);
