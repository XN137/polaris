...
public class InMemoryEntityCache implements EntityCache {
  ...
  public InMemoryEntityCache(
      @Nonnull PolarisRealmConfiguration realmConfig,
    ...
    long weigherTarget =
        realmConfig.getConfiguration(FeatureConfiguration.ENTITY_CACHE_WEIGHER_TARGET);
    ...
    boolean useSoftValues =
        realmConfig.getConfiguration(BehaviorChangeConfiguration.ENTITY_CACHE_SOFT_VALUES);
    if (useSoftValues) {
