...
package org.apache.polaris.core.persistence.session;
...
public class ForwardingMetaStoreSession implements MetaStoreSession {

  private PolarisMetaStoreManager metaStoreManager;
  private final PolarisCallContext callContext;

  public ForwardingMetaStoreSession(
  ...
  @Override
  public PolarisMetaStoreManager swapMetaStoreManager(PolarisMetaStoreManager newMetaStoreManager) {
    PolarisMetaStoreManager oldMetaStoreManager = metaStoreManager;
    metaStoreManager = newMetaStoreManager;
    return oldMetaStoreManager;
  }
  ...
  @Override
  public Optional<PrincipalRoleEntity> findPrincipalRoleByName(String principalRoleName) {
    return metaStoreManager.findPrincipalRoleByName(callContext, principalRoleName);
  }
