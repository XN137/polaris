...
public class PolarisRealmConfigurationImpl implements PolarisRealmConfiguration {

  private final PolarisConfigurationStore configurationStore;
  private final RealmContext realmContext;

  public PolarisRealmConfigurationImpl(
  ...
  @Override
  public <T> @Nonnull T getConfiguration(String configName, @Nonnull T defaultValue) {
    return configurationStore.getConfiguration(realmContext, configName, defaultValue);
  }

  @Override
  public <T> @Nonnull T getConfiguration(PolarisConfiguration<T> config) {
    return configurationStore.getConfiguration(realmContext, config);
  }

  @Override
  public <T> @Nonnull T getConfiguration(
