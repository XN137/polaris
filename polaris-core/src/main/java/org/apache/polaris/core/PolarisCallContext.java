...
import org.apache.polaris.core.config.PolarisRealmConfigurationImpl;
...
public class PolarisCallContext implements CallContext {
  ...
  private final PolarisRealmConfiguration realmConfig;
  ...
  public PolarisCallContext(
    ...
    this.clock = clock;
    this.realmConfig =
        new PolarisRealmConfigurationImpl(this.configurationStore, this.realmContext);
  }
  ...
  @Override
  public PolarisRealmConfiguration getRealmConfiguration() {
    return realmConfig;
  }
